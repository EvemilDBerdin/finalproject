<?php
session_start(); 
(!isset($_SESSION['users_data'])) ? header('location: http://localhost:8088/finalproject') : ($_SESSION['users_data']['role'] != 'student') && header('location: http://localhost:8088/finalproject'); 
?>
...
<head>
    ...
    <title>Students | Berdin's Final Project</title>
    <!-- Favicon -->
